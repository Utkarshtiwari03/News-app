...
//import com.utkarsh.search_presentation.databinding.ActivitySearchBindingImpl
import com.utkarsh.search_presentation.databinding.ViewHolderSearchArticlesBinding
...
class NewsAdapter:RecyclerView.Adapter<NewsAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(val viewDataBinding: ViewHolderSearchArticlesBinding):RecyclerView.ViewHolder(viewDataBinding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsAdapter.MyViewHolder {
        val binding=ViewHolderSearchArticlesBinding.inflate(LayoutInflater.from(parent.context),parent,false)
